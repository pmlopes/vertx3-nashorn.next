...
Pump.pump = function() {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'object' && __args[1]._jdel) {
    return utils.convReturnVertxGen(JPump["pump(io.vertx.core.streams.ReadStream,io.vertx.core.streams.WriteStream)"](__args[0]._jdel, __args[1]._jdel), Pump);
    ...
    return utils.convReturnVertxGen(JPump["pump(io.vertx.core.streams.ReadStream,io.vertx.core.streams.WriteStream,int)"](__args[0]._jdel, __args[1]._jdel, __args[2]), Pump);
  } else throw new TypeError('function invoked with invalid arguments');
};
